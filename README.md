...
## 🧠 About Me  
🎯 Passionate about creating full-stack web applications that make life easier and smarter.  
🌱 Currently exploring *Next.js, **TypeScript, and **Cloud Deployments (AWS & Firebase)*.  
💡 I believe in clean code, collaboration, and continuous learning.  
🤝 Open to working on exciting *open-source* and *freelance projects*.  
...
### 🧾 *Task Manager App*  
🗂 A full-stack app to manage daily tasks with JWT-based authentication.  
...
🛒 A responsive e-commerce platform with cart, product filters, and payment gateway integration.  
🛠 *Tech:* Next.js, Node.js, Stripe API, MongoDB  
🔗 [Live Demo](#) | 💻 [Source Code](#)  

---

### 📚 *Blog Platform*  
✍️ A blog app with markdown support, likes, and comments.  
...
### 🧠 *Portfolio Website*  
🌟 A personal portfolio built to showcase skills, achievements, and projects.  
...
## 🏆 Achievements  
✅ Built 5+ full-stack web projects from scratch  
⭐ Contributed to open-source projects  
💼 Completed internships in web and full-stack development  
